...
const FIELD_MAP = {
  // === ACCOUNT / CUSTOMER ===
  customer_account: ['customer account', 'company', 'customer_account', 'account', 'customer name', 'company name', 'client', 'client name', 'child name'],
  account_id: ['account id', 'account_id', 'crm id', 'salesforce id', 'sf id', 'account number', 'customer account id'],
  ...
  primary_rep: ['primary rep', 'primary_rep', 'assigned rep', 'account owner', 'account executive', 'ae', 'account owner full name'],
  rep_email: ['rep email', 'rep_email', 'owner email', 'ae email'],
  account_manager: ['account manager', 'account_manager', 'am', 'customer success manager', 'csm', 'sales funnel manager', 'funnel manager', 'sales funnel manager (vertical)', 'account owner sales funnel manager vertical', 'account owner sales funnel manager'],
  ...
  total_brr: ['total brr', 'total_brr', 'brr', 'billing recurring revenue', 'annual recurring revenue', 'arr', 'total arr', 'custacct total brr', 'total brr (converted)'],
