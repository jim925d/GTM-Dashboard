...
export default function PlaybookEngine() {
  ...
  const [rules, setRules] = useState(EXTRACTED_RULES)
  ...
  return (
    <div className="p-6 max-w-[1200px] mx-auto space-y-5">
      ...
      <Section title="Similar Deal Pattern Matching" badge={`${SIMILAR_DEALS.length} matches`}>
        <div className="space-y-2.5">
          {SIMILAR_DEALS.map((d, i) => (
      ...
      <Section title="Win/Loss Feedback Loop" badge={`${WIN_LOSS_ITEMS.length} entries`}>
        <div className="space-y-2.5">
          {WIN_LOSS_ITEMS.map((wl, i) => (
      ...
      <Section title="Competitor Profiles" badge={`${COMPETITORS.length} tracked`}>
